...
print("🚀 Starting setup... Please wait!")
print("="*60)
...
print("\n🔑 Step 2/4: Configuring ngrok...")
from pyngrok import ngrok, conf

# IMPORTANT: Replace with YOUR ngrok token
NGROK_TOKEN = "35sH9sAPrFNR8OHCcvYGg2vQt79_71YUU5eyzHKq74yczBauK"  # ← PASTE YOUR TOKEN HERE!
...
print("\n⚠️  FIRST TIME: Model download takes 3-5 minutes")
